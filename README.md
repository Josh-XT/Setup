...
Use Boxes (Gnome Virtual Machine software) to create a new [Windows 10](https://www.microsoft.com/en-us/software-download/windows10ISO) VM with 16GB RAM and 150GB storage.
...
My operating system for my Desktop and Laptop is [Pop!_OS 22.04](https://pop.system76.com/). I use [Visual Studio Code](https://code.visualstudio.com/) as my IDE for all code editing.
